...
export function DashboardClient({ greeting, memory, usage, journalContextEnabled }: { greeting: MomentGreetingOutput; memory: MomentMemorySnapshot | null; usage: { usedMoments: number; momentLimit: number | null; remainingMoments: number | null }; journalContextEnabled: boolean }) {
