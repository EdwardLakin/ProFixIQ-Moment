...
export function GreetingSurface({
  ...
  return (
    <section className="rounded-[1.6rem] bg-[linear-gradient(160deg,#151629,#111522_60%,#131b2d)] p-5 sm:p-7">
      ...
      <MomentTextarea rows={5} value={text} onChange={(event) => onText(event.target.value)} placeholder="Anything is okay: ‘I’m spiraling,’ ‘I can’t focus,’ ‘I feel awful,’ or wherever you want to begin." />
    </section>
  );
}
